...
struct DragGestureBootcamp2: View {
    ...
    var body: some View {
        ZStack {
            ...
            MySignUpView()
                .onAppear(perform: {
                    print("Starting offset Y: \(startingOffsetY)")
                })
...
//                .offset(y: endingOffsetY)
            ...
            VStack(spacing: 12) {
                Text("Starting offset Y: \(startingOffsetY)")
                Text("Current offset Y: \(currentDragOffsetY)")
                Text("Ending offset Y: \(endingOffsetY)")
            }
        } // End of ZStack
